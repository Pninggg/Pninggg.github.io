...
lib.ssMetadata = [
		{name:"16_atlas_1", frames: [[0,0,623,434],[0,436,278,280],[581,467,153,408],[625,0,180,465],[280,669,192,322],[0,718,231,138],[280,436,299,231],[474,877,312,103],[474,669,54,128]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(53).to({_off:false},0).wait(1).to({y:558.95},0).wait(1).to({y:587.95},0).wait(1).to({x:145.5,y:607.95},0).wait(1).to({x:128.05,y:617.95},0).wait(1).to({x:110.15,y:623.95},0).wait(1).to({x:78.1,y:641.45},0).wait(1).to({x:70.85,y:654.1},0).to({_off:true},1).wait(39));
	...
	this.instance_13.setTransform(131.75,393.8,1,1,0,0,0,94.2,228.7);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(41).to({_off:false},0).wait(1).to({x:104.9,y:398.55},0).wait(1).to({x:85.15,y:413.55},0).wait(1).to({x:74.15,y:449.95},0).wait(1).to({x:81.9,y:465.45},0).wait(1).to({x:97.8,y:485.9},0).wait(1).to({x:105.85,y:501.2},0).wait(1).to({x:85.8,y:527.95},0).wait(1).to({x:101.1,y:546.95},0).wait(1).to({y:579.5},0).wait(1).to({x:118.85,y:601.25},0).wait(1).to({x:138.1,y:619.25},0).to({_off:true},1).wait(47));
	...
	this.instance_15.setTransform(167.75,405.05,1,1,0,0,0,94.2,228.7);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(31).to({_off:false},0).wait(1).to({x:155.55,y:432.05},0).wait(1).to({x:127.55,y:442.85},0).wait(1).to({x:103.4,y:458.05},0).wait(1).to({x:112.15,y:480},0).wait(1).to({x:128.15,y:495},0).wait(1).to({y:525.95},0).wait(1).to({x:132.15,y:546.95},0).wait(1).to({x:132.9,y:567.95},0).wait(1).to({x:128.15,y:579.5},0).to({_off:true},1).wait(59));
...
p.nominalBounds = new cjs.Rectangle(186.8,330.3,296.5,552.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/圖層3.png?1765808434704", id:"圖層3"},
		{src:"images/16_atlas_1.png?1765808434686", id:"16_atlas_1"}
	],
	preloads: []
};
